      ...
      <div className="container mx-auto container-padding max-w-3xl">
        ...
        <div className="space-y-10 text-foreground/70 text-[15px] leading-relaxed">
          ...
          <section>
            ...
            <p>This Privacy Policy applies to personal information processed by us, including on our websites, and other online or offline offerings. To make this Privacy Policy easier to read, our websites, and other offerings are collectively called &quot;Services.&quot;</p>
            <p className="mt-4"><strong className="text-foreground">An Important Note:</strong> This Privacy Policy does not apply to any of the personal information that our customers may collect and process using our Services (&quot;Customer Data&quot;). Our customers&apos; respective privacy policies govern their collection and use of Customer Data. Our processing of Customer Data is governed by the contracts that we have in place with our customers, not this Privacy Policy.</p>
            <p className="mt-4"><strong className="text-foreground">Changes to our Privacy Policy:</strong> We may revise this Privacy Policy from time to time in our sole discretion. If there are any material changes, we will notify you as required by applicable law. You understand and agree that you will be deemed to have accepted the updated Privacy Policy if you continue to use our Services after the new Privacy Policy takes effect.</p>
          </section>
          ...
          <section>
            ...
            <p>We may use personal information to tailor and provide you with content and advertisements. We may provide you with these materials as permitted by applicable law, including through email campaigns, custom audiences advertising, and &ldquo;interest-based&rdquo; or &ldquo;personalized advertising.&rdquo;</p>
            <h3 className="font-display text-lg font-semibold text-foreground mt-6 mb-3">D. Other Purposes</h3>
            <p>We may use personal information and other information about you to create de-identified and/or aggregated information. De-identified and/or aggregated information is not personal information, and we may use, disclose, and retain such information as permitted by applicable laws.</p>
          </section>
          ...
          <section>
            ...
            <p className="mt-4"><strong className="text-foreground">Your Privacy Rights.</strong> In accordance with applicable law, you may have the right to:</p>
            <ul className="list-disc pl-6 space-y-2 mt-2">
          ...
          <section>
            ...
            <p>All personal information processed by us may be transferred, processed, and stored anywhere in the world, including, but not limited to, the United States or other countries, which may have data protection laws that are different from the laws where you live. We endeavor to safeguard your personal information consistent with the requirements of applicable laws.</p>
            <p className="mt-4">If we transfer personal information which originates in the European Economic Area, Switzerland, and/or the United Kingdom to a country that has not been found to provide an adequate level of protection under applicable data protection laws, one of the safeguards we may use to support such transfer is the EU Standard Contractual Clauses.</p>
          </section>
          ...
          <section>
            ...
            <p className="mt-4">To determine the appropriate retention period for personal information, we may consider applicable legal requirements, the amount, nature, and sensitivity of the personal information, certain risk factors, the purposes for which we process your personal information, and whether we can achieve those purposes through other means.</p>
          </section>
          ...
          <section>
            ...
            <p><strong className="text-foreground">Supervisory Authority.</strong> If your personal information is subject to the applicable data protection laws of the European Economic Area, Switzerland, or the United Kingdom, you have the right to lodge a complaint with the competent supervisory authority if you believe our processing of your personal information violates applicable law.</p>
          </section>

          <section>
            <h2 className="font-display text-2xl font-semibold text-foreground mb-4">10. Contact Us</h2>
            <p>If you have any questions about our privacy practices or this Privacy Policy, or to exercise your rights as detailed in this Privacy Policy, please contact us at: <a href="mailto:privacy@graphitehq.com" className="underline hover:text-foreground transition-colors">privacy@graphitehq.com</a>.</p>
            <p className="mt-4">If you believe you&apos;ve discovered a potential vulnerability, please let us know by emailing us at <a href="mailto:sec@graphitehq.com" className="underline hover:text-foreground transition-colors">sec@graphitehq.com</a>.</p>
          </section>
        </div>
      </div>
      <Footer />
