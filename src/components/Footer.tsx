      ...
      <div className="container mx-auto container-padding">
        ...
        <div className="flex flex-col md:flex-row justify-between gap-10 md:gap-16 mb-16 sm:mb-20 lg:mb-28">
          ...
          <ul className="flex flex-col gap-1 text-body text-foreground/70">
            <li><a href="#podcast" onClick={(e) => handleNavClick(e, '#podcast')} className="relative hover:text-foreground transition-colors duration-300 group flex items-center gap-2"><span className="h-0 group-hover:h-full w-[2px] transition-all duration-300 ease-smooth" style={{ backgroundColor: '#594881' }} /><span>Podcast</span></a></li>
            <li><a href="#events" onClick={(e) => handleNavClick(e, '#events')} className="relative hover:text-foreground transition-colors duration-300 group flex items-center gap-2"><span className="h-0 group-hover:h-full w-[2px] transition-all duration-300 ease-smooth" style={{ backgroundColor: '#805781' }} /><span>Events</span></a></li>
            <li><a href="#contact" onClick={(e) => handleNavClick(e, '#contact')} className="relative hover:text-foreground transition-colors duration-300 group flex items-center gap-2"><span className="h-0 group-hover:h-full w-[2px] transition-all duration-300 ease-smooth" style={{ backgroundColor: '#9A5B77' }} /><span>Connect</span></a></li>
            <li><button onClick={openSubscribe} className="hover:text-foreground transition-colors duration-300 text-left group flex items-center gap-2"><span className="h-0 group-hover:h-full w-[2px] transition-all duration-300 ease-smooth" style={{ backgroundColor: '#AB5866' }} /><span>Subscribe</span></button></li>
            <li><Link to="/privacy" className="hover:text-foreground transition-colors duration-300 group flex items-center gap-2"><span className="h-0 group-hover:h-full w-[2px] transition-all duration-300 ease-smooth" style={{ backgroundColor: '#B45250' }} /><span>Privacy</span></Link></li>
          </ul>
        </div>
      </div>
