      ...
      <div className="container mx-auto container-padding">
        ...
        <div className="flex flex-col md:flex-row justify-between gap-10 md:gap-16 mb-16 sm:mb-20 lg:mb-28">
          ...
          <ul className="flex flex-col gap-1 text-body text-foreground/70">
            <li><a href="#podcast" onClick={(e) => handleNavClick(e, '#podcast')} className="relative hover:text-foreground transition-colors duration-300 group inline-flex"><span className="absolute right-full top-1/2 -translate-y-1/2 mr-3 h-[2px] w-0 group-hover:w-4 transition-all duration-300 ease-smooth" style={{ backgroundColor: '#594881' }} />Podcast</a></li>
            <li><a href="#events" onClick={(e) => handleNavClick(e, '#events')} className="relative hover:text-foreground transition-colors duration-300 group inline-flex"><span className="absolute right-full top-1/2 -translate-y-1/2 mr-3 h-[2px] w-0 group-hover:w-4 transition-all duration-300 ease-smooth" style={{ backgroundColor: '#805781' }} />Events</a></li>
            <li><a href="#contact" onClick={(e) => handleNavClick(e, '#contact')} className="relative hover:text-foreground transition-colors duration-300 group inline-flex"><span className="absolute right-full top-1/2 -translate-y-1/2 mr-3 h-[2px] w-0 group-hover:w-4 transition-all duration-300 ease-smooth" style={{ backgroundColor: '#9A5B77' }} />Connect</a></li>
            <li><button onClick={openSubscribe} className="relative hover:text-foreground transition-colors duration-300 text-left group inline-flex"><span className="absolute right-full top-1/2 -translate-y-1/2 mr-3 h-[2px] w-0 group-hover:w-4 transition-all duration-300 ease-smooth" style={{ backgroundColor: '#AB5866' }} />Subscribe</button></li>
            <li><Link to="/privacy" className="relative hover:text-foreground transition-colors duration-300 group inline-flex"><span className="absolute right-full top-1/2 -translate-y-1/2 mr-3 h-[2px] w-0 group-hover:w-4 transition-all duration-300 ease-smooth" style={{ backgroundColor: '#B45250' }} />Privacy</Link></li>
          </ul>
        </div>
      </div>
