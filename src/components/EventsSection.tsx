        ...
        <div className="relative">
          ...
          >
            <motion.h2
              ...
              style={{
                background:
                  "linear-gradient(135deg, rgba(20,20,20,1) 0%, rgba(50,45,45,1) 8%, rgba(210,130,130,0.95) 20%, rgba(190,130,160,1) 35%, rgba(150,130,180,0.95) 50%, rgba(90,130,180,1) 65%, rgba(150,130,180,0.95) 80%, rgba(210,130,130,0.95) 100%)",
                backgroundSize: "500% 100%",
                WebkitBackgroundClip: "text",
                backgroundClip: "text",
                color: "transparent",
                animation:
                  !isMobile && isTitleInView
                    ? "gradient-initial-reveal 2s ease-out forwards, gradient-color-only-cycle 10s ease-in-out 2s infinite"
                    : "none",
                lineHeight: 0.95,
                paddingTop: "0.08em",
            ...
            >
              FOM
              <br />
              <span className="block -mt-2 sm:-mt-3 lg:-mt-5 xl:-mt-6">
                2025
              </span>
            </motion.h2>
          </motion.div>
          ...
          <div className="relative flex flex-col lg:flex-row lg:items-end gap-6 lg:gap-0">
            ...
            <div className="hidden lg:flex flex-col justify-end w-1/4 pr-12 pb-4">
              ...
              <p className="text-base text-foreground mt-3">
                An evening of insights, networking, and conversations about the
                future of AI in marketing.
              </p>
              <button
                type="button"
                className="mt-6 text-label hover:opacity-70 hover-transition flex items-center gap-2 group"
              >
                Watch Recap
