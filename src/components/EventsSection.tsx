        ...
        <div className="relative">
          ...
          >
            <motion.h2
              ...
              style={{
                background: 'linear-gradient(135deg, rgba(0,0,0,1) 0%, rgba(0,0,0,1) 30%, rgba(100,160,180,0.85) 50%, rgba(220,120,100,0.9) 65%, rgba(235,160,140,0.85) 80%, rgba(200,140,180,0.9) 100%)',
