      ...
      <div className="container mx-auto container-padding">
        <div className="relative">
          ...
          <motion.h2
            ...
            className="text-[4rem] sm:text-[6rem] lg:text-[10rem] xl:text-[12rem] font-display font-medium leading-[0.85] tracking-tight mb-[-3rem] sm:mb-[-5rem] lg:mb-[-8rem] xl:mb-[-10rem] relative z-10 bg-gradient-to-br from-rose-300/80 via-amber-200/70 to-sky-300/80 bg-clip-text text-transparent animate-gradient-shift"
          >
            FOM<br />2025
          </motion.h2>
