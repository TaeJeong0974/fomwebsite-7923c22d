  ...
  return (
    ...
    >
      <div className="container mx-auto container-padding">
        ...
        <nav className={`rounded-xl transition-all duration-300 ${isScrolled ? 'glass bg-background/80 backdrop-blur-xl px-4 sm:px-5 lg:px-6 py-3 lg:py-4 mt-4' : 'pt-4 lg:pt-6 pb-3 lg:pb-4'}`}>
          <div className={`grid grid-cols-3 items-center ${isScrolled ? '' : 'px-0'}`}>
            ...
            >
              <img src={FomLogo} alt="Future of Marketing" className="h-4 sm:h-5 lg:h-6 xl:h-7" />
            </Link>
