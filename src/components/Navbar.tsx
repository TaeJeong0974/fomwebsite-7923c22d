  ...
  return (
    ...
    >
      <div className="container mx-auto container-padding">
        ...
        <nav className={`rounded-xl py-3 lg:py-4 transition-all duration-300 ${isScrolled ? 'glass bg-background/80 backdrop-blur-xl px-4 sm:px-5 lg:px-6 mt-4' : 'pt-3 lg:pt-5'}`}>
