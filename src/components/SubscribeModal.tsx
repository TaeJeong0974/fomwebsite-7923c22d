...
const SubscribeModal = ({ open, onOpenChange }: SubscribeModalProps) => {
  ...
  return (
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent className="bg-black/80 backdrop-blur-xl border border-white/10 sm:max-w-md p-0 overflow-hidden">
          ...
          {!isSubmitted ? (
            ...
            >
              <DialogHeader className="text-left mb-6">
                <p className="text-[0.8rem] font-medium uppercase tracking-widest text-white mb-2">Stay Updated</p>
