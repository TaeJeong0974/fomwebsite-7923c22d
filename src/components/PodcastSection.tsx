    ...
    <section id="podcast" className="pt-16 md:pt-20 lg:pt-24 pb-14 md:pb-16 lg:pb-20 scroll-mt-24 md:scroll-mt-28">
      <div className="container mx-auto container-padding">
        ...
        <div className="flex items-end justify-between gap-4 sm:gap-6 mb-8 md:mb-10 lg:mb-12">
          ...
          {/* Layout Toggle */}
          <div className="glass rounded-full p-1.5 flex items-center gap-1 !shadow-none hover:!shadow-glass transition-shadow duration-300">
            {([
              ...
              <button 
                ...
                className={`p-2.5 rounded-full transition-all duration-300 flex items-center justify-center gap-2 ${
                  layout === type 
        ...
        <AnimatePresence mode="wait">
          <motion.div
            key={layout}
            initial={{ opacity: 0, scale: 0.92, filter: "blur(8px)", borderRadius: "24px" }}
            animate={{ opacity: 1, scale: 1, filter: "blur(0px)", borderRadius: "0px" }}
            exit={{ opacity: 0, scale: 1.04, filter: "blur(6px)", borderRadius: "16px" }}
            transition={{ 
              duration: 0.5, 
              ease: [0.16, 1, 0.3, 1],
            ...
            >
              ...
              {!isComingSoon && (
                <div className="hidden lg:flex items-center shrink-0">
                  <motion.span
                    className="text-sm font-display font-semibold uppercase tracking-wider rounded-full"
                    initial={false}
                    animate={isHovered ? {
                      color: '#ffffff',
