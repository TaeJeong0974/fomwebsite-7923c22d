          ...
          <div className="flex items-center gap-2">
            ...
            <div ref={sortRef} className="relative">
              <button
                ...
                className="glass rounded-full p-1.5 px-4 flex items-center justify-center gap-2 text-xs font-medium transition-all duration-300 !shadow-none hover:!shadow-glass text-foreground hover:bg-foreground/5 h-[42px]"
              >
