  ...
  return <div className="divide-y divide-border/50">
      ...
      ease: liquidEase
          ...
          <Link to={`/episode/${episode.slug}`} className="group py-6 sm:py-8 flex items-start justify-between gap-6 hover-transition">
            ...
            <span className="shrink-0 mt-2 flex items-center gap-0 group-hover:gap-2 px-4 py-2 rounded-full text-sm font-medium text-foreground bg-transparent group-hover:bg-foreground group-hover:text-background transition-all duration-500 ease-[cubic-bezier(0.22,1,0.36,1)]">
              Watch Now
