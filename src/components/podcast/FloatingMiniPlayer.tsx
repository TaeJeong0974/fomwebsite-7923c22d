      ...
      <div className="rounded-xl p-2.5 bg-background/70 backdrop-blur-xl border border-white/20 shadow-2xl shadow-black/30">
          ...
          <div className="flex items-center gap-1.5 mt-2 px-0.5">
            ...
            <button
              ...
              className="ml-auto w-7 h-7 rounded-full bg-foreground/5 border border-foreground/10 flex items-center justify-center hover:bg-foreground/10 transition-colors duration-200"
