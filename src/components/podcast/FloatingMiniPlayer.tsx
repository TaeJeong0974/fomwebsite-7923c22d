      ...
      <div className="rounded-2xl p-4 bg-background/70 backdrop-blur-xl border border-white/20 shadow-2xl shadow-black/30 transition-transform duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] origin-bottom-right hover:scale-[1.12] hover:-translate-x-2 hover:-translate-y-2">
          ...
          <div className="flex items-center justify-between mt-3 px-0.5">
            <div className="flex items-center gap-2.5">
              <span className="text-sm text-foreground font-semibold">Listen on</span>
              <a
                href={youtubeUrl}
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-foreground/5 border border-foreground/10 flex items-center justify-center hover:bg-foreground/10 transition-colors duration-200"
                aria-label="Watch on YouTube"
              >
                <svg className="w-4.5 h-4.5 text-[#FF0000]" viewBox="0 0 24 24" fill="currentColor">
              ...
              {spotifyUrl && (
                ...
                >
                  <svg className="w-4.5 h-4.5 text-[#1DB954]" viewBox="0 0 24 24" fill="currentColor">
              ...
              >
                <svg className="w-4.5 h-4.5 text-foreground" viewBox="0 0 24 24" fill="currentColor">
