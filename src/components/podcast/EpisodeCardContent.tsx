...
const EpisodeCardContent = ({ 
  ...
  // Grid-based height animation - always expanded on mobile/iPad, hover-triggered on desktop (lg+)
  const hoverWrapperClasses = "grid grid-rows-[1fr] mt-4 lg:grid-rows-[0fr] lg:mt-0 lg:group-hover:grid-rows-[1fr] lg:group-hover:mt-4 transition-[grid-template-rows,margin] duration-700 ease-[cubic-bezier(0.33,1,0.68,1)]";
