  ...
  return (
    <AnimatePresence>
      {visible && (
        ...
        >
          <div className="group/bar flex items-center gap-3 p-2.5 rounded-2xl bg-background/80 backdrop-blur-xl border border-foreground/[0.06] shadow-lg shadow-black/[0.08] transition-transform duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] hover:scale-105">
