...
const StickyBottomBar = ({
  ...
  const iconButton =
    "flex items-center justify-center w-10 h-10 rounded-full bg-white/60 backdrop-blur-2xl border border-white/40 shadow-[0_2px_8px_-2px_rgba(0,0,0,0.08),inset_0_1px_0_rgba(255,255,255,0.6)] transition-[background,box-shadow] duration-300";
  const iconSpring = {
        ...
        >
          ...
          >
            ...
            <div className="flex flex-col mr-0 max-w-0 overflow-hidden transition-all duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] opacity-0 group-hover/bar:max-w-[220px] group-hover/bar:mr-2 group-hover/bar:opacity-100">
              ...
              <span className="text-xs text-foreground/50 truncate whitespace-nowrap">
                {episodeTitle}
              </span>
            </div>
