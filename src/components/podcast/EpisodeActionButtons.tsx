...
const EpisodeActionButtons = ({ youtubeUrl, spotifyUrl }: EpisodeActionButtonsProps) => {
  ...
  const liquidGlassButton = "flex items-center justify-center bg-black/5 backdrop-blur-xl border border-black/10 text-foreground w-12 h-12 rounded-full text-sm font-medium hover:bg-black/10 hover-transition shadow-sm";
