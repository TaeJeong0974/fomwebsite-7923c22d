...
const EpisodeActionButtons = ({ youtubeUrl, spotifyUrl }: EpisodeActionButtonsProps) => {
  ...
  // iOS-style liquid glass button using shared styles
  const liquidGlassButton = `group/btn flex items-center justify-center h-12 px-3.5 rounded-full text-sm font-medium transition-[background,box-shadow] duration-300 ${variantClasses.glass}`;
