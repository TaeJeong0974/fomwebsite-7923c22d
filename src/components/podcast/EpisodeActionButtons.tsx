...
const EpisodeActionButtons = ({ youtubeUrl, spotifyUrl }: EpisodeActionButtonsProps) => {
  ...
  // iOS-style liquid spring animation
  ...
  const liquidGlassButton = "group/btn flex items-center justify-center bg-white/60 backdrop-blur-2xl border border-white/40 text-foreground h-12 px-3.5 rounded-full text-sm font-medium shadow-[0_2px_8px_-2px_rgba(0,0,0,0.08),inset_0_1px_0_rgba(255,255,255,0.6)] md:hover:bg-white/80 md:hover:shadow-[0_4px_16px_-4px_rgba(0,0,0,0.12),inset_0_1px_0_rgba(255,255,255,0.8)] transition-[background,box-shadow] duration-300";

  // Text that appears on hover with liquid animation (desktop only)
  ...
  return (
    <div className="flex gap-2 sm:gap-3">
      ...
      <motion.a
        ...
        transition={springTransition}
      >
        <svg className="w-5 h-5 text-foreground shrink-0" viewBox="0 0 24 24" fill="currentColor">
