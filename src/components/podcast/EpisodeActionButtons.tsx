  ...
  return (
    <div className="flex gap-3 overflow-x-auto pb-2 scrollbar-hide">
      ...
      <a
        ...
        className="flex items-center gap-2.5 bg-muted hover:bg-muted/70 text-foreground px-5 py-3.5 rounded-2xl font-medium hover-transition whitespace-nowrap shrink-0"
      >
