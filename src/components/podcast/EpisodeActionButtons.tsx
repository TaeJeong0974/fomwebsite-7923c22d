  ...
  return (
    <div className="glass rounded-2xl p-6 space-y-3">
      ...
      <a
        ...
        className="flex items-center justify-center gap-2.5 glass-dark text-foreground w-full px-5 py-3.5 rounded-xl font-medium hover:bg-white/10 hover-transition"
      >
