            ...
            {(() => {
              const innerContent = (
                <>
                  <div className="flex-1 min-w-0 text-left">
                    {hasBadge && (
                      <div
                        className={`flex gap-4 sm:gap-6 lg:gap-10 ${isComingSoon ? "lg:hidden" : ""}`}
                      >
                        <span
                          className="text-label invisible"
                          aria-hidden="true"
                        >
                          EP 00
                        </span>
              ...
              return isComingSoon ? (
                <button
                  ...
                  className="w-full text-left group py-6 sm:py-8 flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 sm:gap-6 hover-transition relative z-10 cursor-pointer"
                  onClick={() =>
                    openSubscribe({
