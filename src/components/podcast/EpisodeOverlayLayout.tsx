  ...
  return (
    <div className="min-h-screen bg-muted/40 relative">
      ...
      <main className="relative z-10 pt-8 sm:pt-12 pb-6 sm:pb-8 px-4 sm:px-6">
        ...
        >
          {/* Close Button - absolute, equal horizontal spacing */}
          <motion.button
            variants={closeButtonVariants}
            onClick={handleClose}
            className="absolute top-5 right-6 sm:top-8 sm:right-10 lg:top-10 lg:right-12 z-10 flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-foreground text-background hover:bg-foreground/80 hover:scale-105 hover-transition shadow-lg"
