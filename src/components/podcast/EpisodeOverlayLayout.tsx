    ...
    <div className="min-h-screen bg-muted/40 relative">
      ...
      <main className="relative z-10 pt-12 pb-8 px-4 sm:px-6">
        ...
        <motion.div
          ...
          className="container mx-auto bg-background rounded-3xl shadow-2xl shadow-black/5 overflow-hidden p-8 pr-20 sm:p-10 sm:pr-24 relative"
        >
          {/* Close Button - Absolutely positioned */}
          <button
            onClick={handleClose}
            className="absolute top-5 right-5 sm:top-6 sm:right-6 z-10 flex items-center justify-center w-12 h-12 rounded-full bg-black/5 backdrop-blur-xl border border-black/10 hover:bg-black/10 hover:scale-105 hover-transition shadow-lg shadow-black/5"
