      ...
      {open && (
        <>
          ...
          <motion.div
            ...
            className="fixed right-0 top-0 bottom-0 z-50 w-full max-w-md bg-[#3a3a3a]/95 backdrop-blur-2xl border-l border-white/[0.08] shadow-[-20px_0_50px_-10px_rgba(0,0,0,0.5)]"
          >
            {/* Close button */}
            <motion.button
              onClick={handleClose}
