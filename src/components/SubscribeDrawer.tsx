                  ...
                  >
                    ...
                    <motion.form variants={fadeUpItem} onSubmit={handleSubmit} className="space-y-4">
                      <input
                        ...
                        required
                        autoFocus
                        className="w-full px-6 py-4 text-body font-mono bg-black/[0.03] border border-black/10 rounded-full text-foreground caret-primary placeholder:text-foreground/30 focus-ring hover-transition [caret-width:3px]"
                      />
                      <button
                        type="submit"
