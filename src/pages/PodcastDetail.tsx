          ...
          <div className="lg:col-span-2 space-y-10 sm:space-y-14 lg:space-y-20">
            <FadeInSection className="space-y-4 sm:space-y-6">
              <FloatingMiniPlayer
                ...
                thumbnailImage={episode.slug === "meagen-eisenberg" ? ep1Poster : episode.slug === "lena-waters" ? guestLena : episode.slug === "dave-steer" ? guestDaveCover : episode.slug === "sara-varni" ? guestSaraCover : isIntro ? ep0Poster : undefined}
              />
