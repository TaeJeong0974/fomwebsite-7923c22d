...
From the tradeoffs between authenticity and reach to the risks of messy data and over-personalization, this episode offers a grounded, practical look at how marketers can move faster without losing what makes their work effective.`,
  ...
  },
  {
    ...
    topics: [
      "How Meagen operationalized AI across 95% of her marketing team",
      "Why Samsara built 13 internal AI agents (build vs. buy decisions)",
      "Getting non-technical marketers using AI with no-code tools",
      "Pipeline per employee: the metric that exposes if AI is working",
      "How Samsara tracks visibility inside LLMs in real time",
      "What marketing automates away and why creativity becomes more valuable",
      "Why in-person dinners beat webinars in an AI-saturated world",
      "How to hire for AI-era problem solving, not static skills",
    ],
    chapters: [
