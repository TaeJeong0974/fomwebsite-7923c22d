...
If you're navigating AI, changing search behavior, and building a modern go-to-market strategy, this episode offers a practical and forward-looking perspective on where marketing is headed.`,
    ...
    chapters: [
      ...
      { time: "00:01:37", label: "Customer Obsession As The Through Line Across Every Market" },
      { time: "00:04:59", label: "Reaching SMB Buyers Through Digital, Field, And Community Channels" },
      { time: "00:10:02", label: "Building Market-Specific Strategies For Global Growth" },
      { time: "00:13:06", label: "Creating One Core Message For Many Audiences" },
      { time: "00:20:16", label: "Equipping Teams With AI Tools And Automating High-Impact Workflows" },
      { time: "00:31:02", label: "Marketing For Both Humans And Agents In The New Search Era" },
      { time: "00:45:07", label: "Redefining The Future Of Marketing Teams In An AI-First World" },
    ],
