...
From the tradeoffs between authenticity and reach to the risks of messy data and over-personalization, this episode offers a grounded, practical look at how marketers can move faster without losing what makes their work effective.`,
  ...
  },
  {
    ...
    topics: [
      "Reframing AI: question workflows, not just automate them",
      "Why 'show, don't tell' collapses enterprise sales cycles",
      "How PLG and enterprise motions reinforce each other",
      "Moving ideas to market in hours with AI-enabled knowledge sharing",
      "Why traditional websites may be a growth liability in AI-first discovery",
      "Balancing storytelling and measurement to prove marketing's value",
      "Letting customers and employees shape your brand",
      "The 'warmth vs. competency' framework for moving upmarket",
    ],
    chapters: [],
    youtubeUrl: "",
    spotifyUrl: "",
