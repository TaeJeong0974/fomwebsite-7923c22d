...
Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam.`,
  ...
  },
  {
    ...
    companyDomain: "vertexdigital.com",
  ...
  },
  {
    ...
    title: "VP Demand Gen",
    company: "Catalyst IO",
    companyDomain: "catalystio.com",
    overview: "Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur.",
    bio: "",
    fullDescription: "Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit.",
    topics: ["Topic one", "Topic two", "Topic three"],
    chapters: [],
    youtubeUrl: "",
    spotifyUrl: "",
  ...
  },
  {
    ...
    companyDomain: "meridiangroup.com",
    overview: "At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum.",
    bio: "",
    fullDescription: "At vero eos et accusamus et iusto odio dignissimos ducimus.",
    topics: ["Topic one", "Topic two", "Topic three"],
    chapters: [],
    youtubeUrl: "",
    spotifyUrl: "",
