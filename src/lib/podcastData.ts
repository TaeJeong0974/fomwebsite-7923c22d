...
This episode is a practical blueprint for CMOs and marketing leaders who want AI to move the business, not just the slide deck.`,
    ...
    chapters: [
      ...
      { time: "2:17", title: "Choosing the right CMO role: Market size, customer love, and team quality" },
      { time: "3:41", title: "From product marketing to CMO: the skills that actually matter" },
      { time: "10:15", title: "Putting AI to work in marketing teams without engineers" },
      { time: "19:35", title: "Replacing software, increasing output, and scaling with the same team" },
      { time: "27:02", title: "Creativity, judgment, and what AI still can't replace" },
      { time: "38:11", title: "Measuring AI impact, favorite tools, and what the future of marketing looks like" },
    ],
